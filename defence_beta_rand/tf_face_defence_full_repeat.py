...
from defend_faces import generate_protection_noise
...
def main_run(selection, ratio):
    ...
    if resample_users:
        ...
        rand_data = a.normalize_external(rand_data)
    ...
    # Create temp dir for tensorflow
    ...
    return (TPR_holder, FPR_holder, AR_holder,
            sorted(a.users.keys()), RAR_holder)
...
if __name__ == "__main__":
    ...
    for _ in range(1):
        ...
        mkdir_p("./user_defence_results/{}_probaresults/".format(clf_titles[selection]))

        results_holder.append(main_run(selection, ratio))
    tmp_file = tempfile.mkstemp(suffix=".pickle",
                                dir="./user_defence_results/{}_probaresults/".format(
