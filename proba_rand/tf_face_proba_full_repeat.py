...
def main_run(selection):
    ...
    run_tmp_dir = tempfile.mkdtemp(dir="/scratch1/zha197/facenet/models/")  # create dir
...
if __name__ == "__main__":
    ...
    for _ in range(1):
        ...
        mkdir_p("./user_proba_results/{}_probaresults/".format(clf_titles[selection]))

        results_holder.append(main_run(selection))
    tmp_file = tempfile.mkstemp(suffix=".pickle",
                                dir="./user_proba_results/{}_probaresults/".format(
